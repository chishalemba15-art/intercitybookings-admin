...
export async function GET(
  ...
  try {
    ...
    // Get available agents for this operator
    ...
    const availableAgents = await db
      ...
      .where(
        and(
          ...
          or(
            eq(agents.primaryOperatorId, booking.operatorId || 0),
            and(
              eq(agentOperatorAssignments.operatorId, booking.operatorId || 0),
    ...
    // Get assignment history for this booking
    ...
    // Get currently assigned agent details if any
